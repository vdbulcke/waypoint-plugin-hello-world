PLUGIN_NAME=hello-world-builder
...
protos:
	...
	# protoc -I . --go-grpc_out=. --go-grpc_opt=paths=source_relative ./builder/output.proto
	# protoc -I . --go_out=plugins=grpc:. --go_opt=paths=source_relative --go-grpc_out=. --go-grpc_opt=paths=source_relative ./builder/output.proto
